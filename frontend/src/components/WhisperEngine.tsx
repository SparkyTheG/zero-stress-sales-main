          ...
          <div className="animate-slide-up border-t border-teal-400/20 pt-6">
            <div className="bg-gradient-to-br from-teal-500/10 to-cyan-500/10 border border-teal-400/40 rounded-2xl p-6 glow-teal">
              <div className="flex items-start gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-teal-300 mb-1">{scripts[0].title}</h3>
                  <div className="text-sm space-y-1">
                    <p className="text-cyan-400">
                      <span className="text-white/60">Trigger:</span> {scripts[0].dialTrigger}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4 mt-6">
                {scripts[0].steps?.map((step: ScriptStep) => (
